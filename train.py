...
FINAL_MODEL_PATH = os.path.join(MODEL_DIR, "tac_ses01_dim3.pth")

TRAIN_SUBS = Config.TRAIN_SUBJECTS


# ================= Dataset (Modified to Ses-02) =================
...
def main():
    ...
    print(f"🚀 Training BCNE Original on Ses-01")
